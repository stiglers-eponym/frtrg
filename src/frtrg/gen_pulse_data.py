...
def main():
    ...
    phys_group.add_argument(
        "pulse_shape",
        type=str,
        choices=["gauss", "gauss_symmetric", "updown_gauss"],
        default="gauss",
    ...
    phys_group.add_argument(
        "--pulse_height", metavar="float", type=float, help="height of voltage pulses"
    )
    phys_group.add_argument(
        "--pulse_separation",
        metavar="float",
    ...
    numerics_group.add_argument(
        "--nmax", metavar="int", type=int, required=True, help="Floquet matrix size"
    )
    numerics_group.add_argument(
        "--padding", metavar="int", type=int, default=0, help="Floquet matrix ppadding"
    )
    numerics_group.add_argument(
        "--voltage_branches",
        metavar="int",
...
def fourier_coef_updown_gauss(
    ...
    trash, coef_gauss = fourier_coef_gauss(nmax, omega, duration, height, phase, 0.0)
